...
bool isKeyValid(const string &key, const string &alphabet)
{
    ...
    {
        cout << "Key length must match the alphabet length (97 characters)." << std::endl;
        return false;
    }
...
int main()
{
    ...
    // string keyrandom = generateRandomKey(alphabet);
    // cout << "Key random: " << keyrandom;
    // cout << "\nDo dai key random: " << keyrandom.length() << endl;
    // string key;
    // while (true)
    // {
    ...
    //     else
    //     {
    //         std::cout << "Please re-enter the key." << std::endl;
    //     }
    // }
